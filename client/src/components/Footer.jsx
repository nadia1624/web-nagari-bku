...
const Footer = () => {
  ...
  return (
    <footer className="bg-white text-gray-800 mt-auto relative border-t border-gray-200">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-3">
              {[{icon: Facebook, color: 'blue-600'}, {icon: Instagram, color: 'pink-500'}, {icon: Twitter, color: 'sky-500'}, {icon: Youtube, color: 'red-600'}].map((social, i) => {
                ...
                return (
                  <a key={i} href="#" className={`w-10 h-10 bg-gray-100 hover:bg-${social.color} hover:text-white rounded-full flex items-center justify-center transition transform hover:scale-110 text-gray-600`}>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-5 text-blue-600">Kontak Kami</h3>
            <ul className="space-y-4 text-sm text-gray-600">
              <li className="flex gap-3">
                <MapPin className="w-5 h-5 text-blue-600" />
                Nagari Batu Kalang Utara, Kec. Padang Pariaman, Sumatera Barat
              </li>
              <li className="flex gap-3">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-5 text-blue-600">Jam Pelayanan</h3>
        ...
        <div className="border-t border-gray-300 pt-6 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          ...
          <div className="flex items-center gap-3">
            <a className="hover:text-blue-600 transition-colors">By KKN UNAND 2025</a>
          </div>
        </div>
      </div>
